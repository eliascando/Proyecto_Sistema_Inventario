...
namespace Modelo
{
    public class Actividad
    {
        ...
        public Actividad(int id_actividad, DateTime fechayhora, int ingreso_stock,string tipo_actividad, int codigo_producto,string nombre_producto, int id_usuario)
        {
